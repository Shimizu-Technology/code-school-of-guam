...
const footerLinks = [
  ["Focused Courses", "/courses"],
  ["Python Fundamentals", "/courses/python-fundamentals"],
  ["Full Bootcamp", "/programs"],
  ["Bootcamp Curriculum", "/curriculum"],
      ...
      <div className="container mx-auto px-4 py-12 sm:px-8 md:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div className="max-w-md">
            ...
            <p className="mt-5 text-sm leading-relaxed text-slate-400">Focused coding courses and a full software development bootcamp, taught from Guam with real production context.</p>
          ...
          <div>
            ...
            <Link href="/courses" className="mt-5 inline-flex items-center gap-2 rounded-md bg-ruby-600 px-4 py-2.5 text-sm font-bold text-white hover:bg-ruby-500">Explore courses <ArrowUpRight className="h-4 w-4" /></Link>
          </div>
        </div>
