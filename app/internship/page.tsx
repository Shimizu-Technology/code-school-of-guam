          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-2xl p-8 md:p-10 border border-slate-200">
              <div className="flex items-start mb-6">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 text-lg">Leon Shimizu</h3>
                  <p className="text-sm text-slate-600">Founder, Code School of Guam & Shimizu Technology</p>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">Teaching Assistant</h3>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">Junior Software Engineer</h3>
                <p className="text-slate-600 mb-4">
                  Join{" "}
                  <a 
                    href="https://shimizu-technology.com" 
