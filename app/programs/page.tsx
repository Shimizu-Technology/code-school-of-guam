            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-md">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <div className="text-2xl font-bold text-gray-900">15-16</div>
                  <div className="text-sm text-gray-600">Hours/Week</div>
                </div>
                <div className="bg-gray-50 rounded-lg p-4 text-center">
                  <div className="text-2xl font-bold text-gray-900">Max 10</div>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Live Classes:</h4>
                    <p className="text-gray-600 text-sm">Monday – Thursday, 6:00pm – 9:00pm</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-1 h-full bg-gray-300 rounded mr-3 self-stretch"></div>
                  <div>
                    <h4 className="font-semibold text-gray-900">3-Day Weekend:</h4>
                    <p className="text-gray-600 text-sm">Homework & Deliberate Practice</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 md:p-8 border border-green-200 shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Without real-world experience</div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-gray-50 rounded-xl p-6 text-center border border-gray-200">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Pay in Full</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-6 text-center border border-gray-200">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">PFC Financing</h3>
          ...
          <div className="max-w-2xl mx-auto mt-12 text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Our Commitment to Accessibility</h3>
            <p className="text-gray-600">
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/faq"
              className="inline-flex items-center text-gray-300 hover:text-white font-medium"
            >
              View FAQs
